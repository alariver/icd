...
AmCharts.AxisBase = AmCharts.Class({construct: function () {
    ...
    var a = this.chart;
    void 0 === this.titleColor && (this.titleColor =
        a.color);
    ...
    draw: function () {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum))this.fire("logarithmicAxisFailed", {type: "logarithmicAxisFailed", chart: a}); else {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity ==
                this.max)g = !0; else {
                var l = this.labelFrequency, m = this.showFirstLabel, n = this.showLastLabel, p = 1, q = 0, u = Math.round((this.max - this.min) / this.step) + 1, r;
                ...
                var t, A = this.guides, E = A.length;
                if (0 < E) {
                    c = this.fillAlpha;
                    for (d = this.fillAlpha = 0; d < E; d++) {
                        var x = A[d], z = NaN, H = x.above;
                        isNaN(x.toValue) || (z =
                            this.getCoordinate(x.toValue), t = new this.axisItemRenderer(this, z, "", !0, NaN, NaN, x), this.pushAxisItem(t, H));
                        var I = NaN;
                ...
                A = !1;
                for (d = q; d < u; d += p)E = AmCharts.roundTo(this.step * d + this.min, s), -1 != String(E).indexOf("e") &&
                    (A = !0, String(E).split("e"));
                this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
                var s = this.step, B, E = this.minorGridAlpha;
                ...
                for (d = q; d < u; d += p)if (q = s * d + this.min, q = AmCharts.roundTo(q, this.maxDecCount + 1), !this.integersOnly || Math.round(q) == q)if (isNaN(w) || Number(AmCharts.toFixed(q, w)) == q) {
                    ...
                    this.duration && (t = AmCharts.formatDuration(q, this.duration, "", this.durationUnits, this.maxInterval,
                        v));
                    ...
                    if (q == this.baseValue && "radar" != k) {
                        var ba, N, H = this.viW, z = this.viH;
                        t = this.viX;
                        x = this.viY;
                        "H" == this.orientation ? 0 <= c && c <= H + 1 && (ba = [c, c, c + e], N = [z, 0, f]) : 0 <= c && c <= z + 1 && (ba = [0, H, H + e], N = [c, c, c + f]);
                        ba && (c = AmCharts.fitToBounds(2 *
                            this.gridAlpha, 0, 1), c = AmCharts.line(a.container, ba, N, this.gridColor, c, 1, this.dashLength), c.translate(t, x), this.grid0 = c, a.axesSet.push(c), c.toBack())
                    }
                ...
                this.min < this.baseValue && this.max < this.baseValue && (d =
                    this.max);
        ...
        for (k = this.start; k <= this.end; k++) {
            var u = 0;
            for (n = 0; n < h.length; n++)if (m = h[n], !m.hidden && (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id],
                g = l.values.value, !isNaN(g)))) {
                ...
                "regular" == b && (q && (isNaN(c[k]) ? (c[k] = g, l.values.close = g, l.values.open = this.baseValue) : (isNaN(g) ? l.values.close = c[k] : l.values.close = g + c[k], l.values.open = c[k], c[k] = l.values.close)), "column" != a || isNaN(g) || (l.values.close = g, 0 > g ? (l.values.close = g, isNaN(d[k]) ? l.values.open =
                    p : (l.values.close += d[k], l.values.open = d[k]), d[k] = l.values.close) : (l.values.close = g, isNaN(e[k]) ? l.values.open = p : (l.values.close += e[k], l.values.open = e[k]), e[k] = l.values.close)))
            }
        }
        for (k = this.start; k <= this.end; k++)for (n = 0; n < h.length; n++)m = h[n], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g) || (c = 100 * (g / f[k]), l.values.percents = c, l.values.total = f[k], "100%" == b && (isNaN(d[k]) && (d[k] = 0), isNaN(e[k]) && (e[k] = 0),
            0 > c ? (l.values.close = AmCharts.fitToBounds(c + d[k], -100, 100), l.values.open = d[k], d[k] = l.values.close) : (l.values.close = AmCharts.fitToBounds(c + e[k], -100, 100), l.values.open = e[k], e[k] = l.values.close)))))
        ...
        "serial" == b.chartType &&
        (!0 !== b.categoryAxis.parseDates || a || this.end < this.data.length - 1 && this.end++);
        ...
        this.logarithmic && (2 < c ? (this.minReal = this.min = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)), this.max = Math.pow(10, Math.ceil(Math.log(Math.abs(b)) * Math.LOG10E))) : (b = Math.pow(10,
            Math.floor(Math.log(Math.abs(this.min)) * Math.LOG10E)) / 10, a = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)) / 10, b < a && (this.minReal = this.min = 10 * a)))
    }, fixStepE: function (a) {
        ...
        var b = this.axisWidth, c = this.stepWidth, d = this.reversed, e = this.rotate,
            f = this.min, g = this.minReal;
        ...
        b = this.rotate ? b + (this.x -
            this.viX) : b + (this.y - this.viY);
        return Math.round(b)
        ...
        d && (this.min = a * d, this.max = c * d, this.step = b * d, a = Math.pow(10, Math.floor(Math.log(Math.abs(this.step)) * Math.LOG10E)),
            a = Math.abs(Math.log(Math.abs(a)) * Math.LOG10E), this.maxDecCount = a = Math.round(a), this.draw())
    }});
...
AmCharts.RecItem = AmCharts.Class({construct: function (a, b, c, d, e, f, g, h, k, l) {
    ...
    k || (k = 0);
    void 0 == d && (d = !0);
    var m = a.chart.fontFamily, n = a.fontSize;
    void 0 == n && (n = a.chart.fontSize);
    var p = a.color;
    void 0 == p && (p = a.chart.color);
    var q = a.chart.container, u = q.set();
    this.set = u;
    var r = a.axisThickness, s = a.axisColor, w = a.axisAlpha, v = a.tickLength, t = a.gridAlpha, A = a.gridThickness, E = a.gridColor, x = a.dashLength, z = a.fillColor, H = a.fillAlpha, I = a.labelsEnabled, B = a.labelRotation, ba = a.counter, N = a.inside,
        $ = a.dx, V = a.dy, Da = a.orientation, ca = a.position, Y = a.previousCoord, O = a.viH, U = a.viW, na = a.offset, W, X;
    ...
    e && (X = "middle");
    var ga =
        B * Math.PI / 180, ha, G = 0, F = 0, ia = 0, aa = ha = 0;
    "V" == Da && (B = 0);
    var y;
    I && (y = AmCharts.text(q, c, p, m, n, X, h), aa = y.getBBox().width);
    if ("H" == Da) {
        if (0 <= b && b <= U + 1 && (0 < v && 0 < w && b + k <= U + 1 && (W = AmCharts.line(q, [b + k, b + k], [0, v], s, w, A), u.push(W)), 0 < t && (X = AmCharts.line(q, [b, b + $, b + $], [O, O + V, V], E, t, A, x), u.push(X))), F = 0, G = b, g && 90 == B && (G -= n), !1 === d ? (X = "start", F = "bottom" == ca ? N ? F + v : F - v : N ? F - v : F + v, G += 3, e && (G += e / 2, X = "middle"), 0 < B && (X = "middle")) : X = "middle", 1 == ba && 0 < H && !g && !l && Y < U && (d = AmCharts.fitToBounds(b, 0, U), Y = AmCharts.fitToBounds(Y,
            ...
            y && (ca = 0, N && (ca = aa / 2 * Math.cos(ga)), V + ca > U + 2 || 0 > V))y.remove(), y = null
    } else {
        ...
        F += n / 2;
        "right" ==
            ca ? (G += $ + U + na, F += V, N ? (G -= v + 4, f || (F -= n / 2 + 3)) : (G += v + 4 + r, F -= 2)) : N ? (G += v + 4 - na, f || (F -= n / 2 + 3), g && (G += $, F += V)) : (G += -v - r - 4 - 2 - na, F -= 2);
    ...
    y && (y.attr({"text-anchor": X}), y.translate(G, F), 0 !== B && y.rotate(-B, a.chart.backgroundColor), a.allLabels.push(y), " " != c && (this.label = y));
    l || (a.counter = 0 ===
        ba ? 1 : 0, a.previousCoord = b);
...
AmCharts.AmChart = AmCharts.Class({construct: function () {
    ...
    if (AmCharts.ifArray(a)) {
        ...
        for (c = 0; c < a.length; c++) {
            ...
            e.translate(g + (this.realWidth - this.marginRight -
                g) / 2, b);
            g = !0;
    ...
    AmCharts.callMethod("clear",
        [this.chartScrollbar, this.scrollbarV, this.scrollbarH, this.chartCursor]);
    ...
    if (c) {
        var d = this.legendDiv, e = d.offsetWidth, f = d.offsetHeight, d = d.style, g = this.chartDiv.style, c = c.position;
...
AmCharts.AmGraph = AmCharts.Class({construct: function () {
    ...
    createRadarGraph: function () {
        ...
        var a = this.chart, b = this.id, c = this.index, d = this.data, e = this.chart.container, f = this.valueAxis, g = this.type, h = this.columnWidthReal;
        isNaN(this.columnWidth) || (h = this.columnWidth);
        var k = this.width, l = this.height, m = this.y, n = this.rotate, p = this.columnCount, q = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), u = this.connect, r = [], s = [], w, v, t, A, E = this.chart.graphs.length,
            x, z = this.dx / this.depthCount, H = this.dy / this.depthCount, I = f.stackType, B = this.labelPosition, ba = this.start, N = this.end, $ = this.scrollbar, V = this.categoryAxis, Da = this.baseCoord, ca = this.negativeBase, Y = this.columnIndex, O = this.lineThickness, U = this.lineAlpha, na = this.lineColor, W = this.dashLength, X = this.set;
        "above" == B && (B = "top");
        "below" == B && (B = "bottom");
        var ga = B, ha = this.getGradRotation(), G = this.chart.columnSpacing, F = V.cellWidth, ia = (F * h - p) / p;
        G > ia && (G = ia);
        var aa, y, Qa, Ya = l + 1, Za = k + 1, Ra = 0, $a = 0, ab, bb, Sa, Ta, Hb = this.fillColors,
            Ha = this.negativeFillColors, ya = this.negativeLineColor, Ia = this.fillAlphas, Ja = this.negativeFillAlphas;
        ...
        if (!$ && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), Ha || void 0 != ya)) {
            ...
            var ua = f.getCoordinate(Ea), sb = f.getCoordinate(f.max);
        ...
        for (P = ba; P <= N; P++) {
            ...
            y.index = P;
            var K, L, J, da, oa = NaN, D = NaN, C = NaN, Q = NaN, M = NaN, La = NaN, za = NaN, Ma = NaN, Aa = NaN, Z = NaN, fa = NaN, pa = NaN, qa = NaN, R = NaN, cb = NaN, db = NaN, ja = NaN, la = void 0, wa = Hb, Na = Ia, ra = na, ka, sa, eb = this.pattern;
            ...
            if (ta) {
                ...
                if ("candlestick" == g || "ohlc" == g)R =
                    ta.close, db = ta.low, za = f.getCoordinate(db), cb = ta.high, Aa = f.getCoordinate(cb);
                ja = ta.open;
                C = f.getCoordinate(R);
                ...
                var oa = aa.x[V.id], ma = Math.floor(F / 2), Ba = ma;
                ...
                -1E5 > oa && (oa = -1E5);
                oa > k + 1E5 && (oa = k + 1E5);
                n ? (D = C, Q = M, M = C = oa, isNaN(ja) && !this.fillToGraph &&
                    (Q = Da), La = za, Ma = Aa) : (Q = D = oa, isNaN(ja) && !this.fillToGraph && (M = Da));
                R < ja && (y.isNegative = !0, Ha && (wa = Ha), Ja && (Na = Ja), void 0 != ya && (ra = ya));
                switch (g) {
                    case "line":
                        isNaN(R) ? u || (this.drawLineGraph(r, s, S, T), r = [], s = [], S = [], T = []) : (y.isNegative = R < ca ? !0 : !1, r.push(D), s.push(C), Z = D, fa = C, pa = D, qa = C, !Ka || isNaN(M) || isNaN(Q) || (S.push(Q), T.push(M)), void 0 == y.lineColor && void 0 == y.fillColors && isNaN(y.dashLength) || (this.drawLineGraph(r, s, S, T), r = [D], s = [C], S = [], T = [], this.lineColorSwitched = y.lineColor, this.fillColorsSwitched =
                    ...
                    case "step":
                        isNaN(R) ?
                            ...
                            (s.push(v), r.push(D - ma)), r.push(D - ma), s.push(C), r.push(D + Ba), s.push(C), !Ka || isNaN(M) || isNaN(Q) || (S.push(Q - ma), T.push(A), S.push(Q - ma), T.push(M), S.push(Q + Ba), T.push(M))), w = D, v = C, t = Q, A = M, Z = D, fa = C, pa = D, qa = C, tb && (w = v = NaN, this.drawLineGraph(r, s, S, T), r = [], s = [], S = [], T = []));
                        break;
                    case "column":
                        ka = ra;
                        ...
                        if (!isNaN(R)) {
                            ...
                            var ub = f.min, vb = f.max;
                            if (!(R < ub && ja < ub || R > vb && ja > vb))if (n) {
                                "3d" == I ? (L = C - 0.5 * (h + G) + G / 2 +
                                    H * Y, K = Q + z * Y) : (L = C - (p / 2 - Y) * (h + G) + G / 2, K = Q);
                                J = h;
                                Z = D;
                                fa = L + h / 2;
                                pa = D;
                                ...
                                if (L < l && 0 < J && (la = new AmCharts.Cuboid(e, da, J, z - a.d3x, H - a.d3y, wa, Na, O, ka, U, ha, q, n, W, eb), "bottom" != B))if (B = f.reversed ? "left" : "right", 0 > R)B = f.reversed ? "right" : "left"; else if ("regular" == I || "100%" == I)Z += this.dx
                            } else {
                                ...
                                if (K < k + Y * z && 0 < J)if (la = new AmCharts.Cuboid(e, J, da, z - a.d3x, H - a.d3y, wa, Na, O, ka, this.lineAlpha, ha, q, n, W, eb), 0 > R && "middle" != B)B = "bottom"; else if (B = ga, "regular" == I || "100%" == I)fa += this.dy
                            }
                            if (la && (sa = la.set, sa.translate(K, L), this.columnsSet.push(sa), (y.url || this.showHandOnHover) && sa.setAttr("cursor", "pointer"), !$)) {
                                ...
                                "3d" ==
                                    I && (n ? (x = (E - c) * (this.end + 1 - P), Z += z * this.columnIndex, pa += z * this.columnIndex, y.y += z * this.columnIndex) : (x = (E - c) * (P + 1), Z += 3, fa += H * this.columnIndex + 7, qa += H * this.columnIndex, y.y += H * this.columnIndex));
                                if ("regular" == I || "100%" == I)B = "middle", x = n ? 0 < ta.value ? (this.end + 1 - P) * E + c : (this.end + 1 - P) * E - c : 0 < ta.value ? E * P + c : E * P - c;
                                this.columnsArray.push({column: la, depth: x});
                                y.x = n ? L + J / 2 : K + J / 2;
                    ...
                    case "candlestick":
                        if (!isNaN(ja) && !isNaN(R)) {
                            ...
                            if (n) {
                                ...
                                var la = new AmCharts.Cuboid(e, J, da, z, H, wa, Na, O, ka, U, ha, q, n, W), jb, kb;
                                R > ja ? (jb = [C, Aa],
                                    kb = [M, za]) : (jb = [M, Aa], kb = [C, za]);
                    ...
                    case "ohlc":
                        if (!(isNaN(ja) || isNaN(cb) || isNaN(db) || isNaN(R))) {
                            ...
                            var lb, mb,
                                nb;
                            if (n) {
                                var ob = C - h / 2, ob = AmCharts.fitToBounds(ob, 0, l), wb = AmCharts.fitToBounds(C, 0, l), pb = C + h / 2, pb = AmCharts.fitToBounds(pb, 0, l);
                                mb = AmCharts.line(e, [Q, Q], [ob, wb], ra, U, O, W);
                                0 < C && C < l && (lb = AmCharts.line(e, [La, Ma], [C, C], ra, U, O, W));
                                nb = AmCharts.line(e, [D, D], [wb, pb], ra, U, O, W)
                            } else {
                                var qb = D - h / 2, qb = AmCharts.fitToBounds(qb, 0, k), xb = AmCharts.fitToBounds(D, 0, k), rb = D + h / 2, rb = AmCharts.fitToBounds(rb, 0, k);
                ...
                if (!$ && !isNaN(R)) {
                    ...
                    if (this.end - this.start <= yb || 0 === yb) {
                        ...
                        if (zb) {
                            var ea = this.createLabel(y, 0, 0, zb), xa = 0, Ca = 0, Ab = ea.getBBox(), Wa = Ab.width, Xa = Ab.height;
                            switch (B) {
                                case "left":
                                    xa = -(Wa / 2 + Fa / 2 + 3);
                                    break;
                                ...
                                case "bottom":
                                    n && "column" == g ? (Z = Da, 0 > R ? (xa = -6, ea.attr({"text-anchor": "end"})) :
                                        (xa = 6, ea.attr({"text-anchor": "start"}))) : (Ca = Fa / 2 + Xa / 2, ea.x = -(Wa / 2 + 2));
                                    break;
                                case "middle":
                            ...
                            if (ea) {
                                if (isNaN(fa) || isNaN(Z))ea.remove(), ea = null; else if (Z += xa, fa += Ca, ea.translate(Z, fa), n) {
                                    if (0 > fa || fa > l)ea.remove(), ea = null
                                } else {
                                    var Bb = 0;
                                    "3d" == I && (Bb = z * Y);
                                    if (0 > Z || Z > k + Bb)ea.remove(),
                                        ea = null
                                }
                        ...
                        if ("column" == g && "regular" == I || "100%" == I) {
                            ...
                            if (Cb) {
                                ...
                                var Db = Ga.getBBox(), Eb = Db.width, Fb = Db.height, Oa, Pa, Gb = f.totals[P];
                                Gb && Gb.remove();
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(r,
            s, S, T) : this.drawLineGraph(r, s, S, T), $ || this.launchAnimation();
        ...
        if (1 < a.length) {
            ...
            f.push(k);
            f.push(h);
            var l = e.lineAlpha, m = e.lineThickness, f = e.fillAlphas, n = e.lineColor,
                p = e.negativeLineAlpha;
            isNaN(p) && (p = l);
            var q = e.lineColorSwitched;
            q && (n = q);
            var q = e.fillColors, u = e.fillColorsSwitched;
            u && (q = u);
            var r = e.dashLength;
            (u = e.dashLengthSwitched) && (r = u);
            var u = e.negativeLineColor, s = e.negativeFillColors, w = e.negativeFillAlphas, v = e.baseCoord;
        ...
        if (1 < a.length) {
            ...
            e.push(h);
            e.push(g);
            var k = this.lineAlpha, l = this.lineThickness, e = this.dashLength, m = this.fillAlphas, n = this.lineColor, p = this.fillColors, q = this.negativeLineColor, u = this.negativeFillColors, r = this.negativeFillAlphas,
                s = this.baseCoord, w = this.lineColorSwitched;
            w && (n = w);
            ...
            0 < m && (k = a.join(";").split(";"), n = b.join(";").split(";"), l = "", 0 < c.length ? (c.reverse(), d.reverse(), k = a.concat(c), n = b.concat(d)) : (this.rotate ? (l += " L" + s + "," + b[b.length - 1], l += " L" + s + "," + b[0]) : (l += " L" + a[a.length - 1] + "," + s, l += " L" + a[0] + "," + s), l += " L" + a[0] +
                "," + b[0]), c = new AmCharts.Bezier(f, k, n, NaN, 0, 0, p, m, e, l), c.path.pattern(this.pattern), g.push(c.path), u || void 0 !== q) && (r || (r = m), u || (u = q), a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, u, r, e, l), a.path.pattern(this.pattern), h.push(a.path));
            this.applyMask(h, g)
        }
        ...
        e = this.bullet;
        a.bullet && (e = a.bullet);
        var g = this.bulletBorderThickness, m = this.bulletBorderColor, n = this.bulletBorderAlpha, p = this.bulletAlpha;
        m || (m = l);
        var q = a.alpha;
        isNaN(q) || (p = q);
        if ("none" != this.bullet || a.bullet)k = AmCharts.bullet(d, e, f, l, p, g, m, n, h);
        if (this.customBullet || a.customBullet)h = this.customBullet, a.customBullet && (h = a.customBullet), h && (k && k.remove(), "function" == typeof h ? (k = new h, k.chart = this.chart, a.bulletConfig && (k.availableSpace = c, k.graph = this, a.bulletConfig.minCoord =
            this.minCoord - c, k.bulletConfig = a.bulletConfig), k.write(d), k = k.set) : (this.chart.path && (h = this.chart.path + h), k = d.set(), d = d.image(h, 0, 0, f, f), k.push(d), this.centerCustomBullets && d.translate(-f / 2, -f / 2)));
        ...
        if (a) {
            ...
            if (d) {
                var d = c.formatString(this.balloonText, a, a.graph), e = this.balloonFunction;
                e && (d = e(a, a.graph));
                d = AmCharts.cleanFromEmpty(d);
                e =
                    c.getBalloonColor(this, a);
        ...
        if (a) {
            var c = {type: "clickGraphItem", item: a, index: a.index, graph: this,
                target: this, chart: this.chart, event: b};
        ...
        if (a) {
            ...
            this.chart.fire("rightClickGraphItem",
                c)
        }
...
AmCharts.ChartCursor = AmCharts.Class({construct: function () {
    ...
    var a = this.chart, b = this.cursorAlpha, c = a.categoryAxis, d = c.position, e = c.inside, f = c.axisThickness, g = this.categoryBalloon, h, k, l = a.dx, m = a.dy, n = this.x, p = this.y, q = this.width, u = this.height, a = a.rotate, r = c.tickLength;
    g.pointerWidth = r;
    a ? (h = [0, q, q + l], k = [0, 0, m]) : (h = [l, 0, 0], k = [m, 0, u]);
    this.line = b = AmCharts.line(this.container, h, k, this.cursorColor, b, 1);
    this.set.push(b);
    a ? (e && (g.pointerWidth = 0), "right" == d ? e ? g.setBounds(n, p + m,
        n + q + l, p + u + m) : g.setBounds(n + q + l + f, p + m, n + q + 1E3, p + u + m) : e ? g.setBounds(n, p, q + n, u + p) : g.setBounds(-1E3, -1E3, n - r - f, p + u + 15)) : (g.maxWidth = q, c.parseDates && (r = 0, g.pointerWidth = 0), "top" == d ? e ? g.setBounds(n + l, p + m, q + l + n, u + p) : g.setBounds(n + l, -1E3, q + l + n, p + m - r - f) : e ? g.setBounds(n, p, q + n, u + p - r) : g.setBounds(n, p + u + r + f - 1, n + q, p + u + r + f));
    this.hideCursor()
}, createCrosshair: function () {
    var a = this.cursorAlpha, b = this.container, c = AmCharts.line(b, [0, 0], [0, this.height], this.cursorColor, a, 1), a = AmCharts.line(b, [0, this.width], [0, 0], this.cursorColor,
        a, 1);
    this.set.push(c);
    this.set.push(a);
    this.vLine = c;
    ...
    getMousePosition: function () {
        ...
        this.zooming && (a.hideXScrollbar && (b = NaN), a.hideYScrollbar && (c =
            NaN), this.updateSelectionSize(b, c));
        ...
        var a =
            this.valueBalloons, b = this.x, c = this.y, d = this.height + c;
    ...
    destroyValueBalloons: function () {
        ...
        if ("cursor" == this.type) {
            if (AmCharts.ifArray(this.data)) {
                ...
                if ((a != this.previousMousePosition || !0 === this.zoomed || this.oneBalloonOnly) && !isNaN(a)) {
                    ...
                    if (c != this.previousIndex || this.zoomed || "mouse" == this.cursorPosition || this.oneBalloonOnly)this.updateCursor(c,
                        b), this.zoomed = !1
                }
        ...
        if (this.enabled) {
            void 0 ===
                b && (b = !0);
            this.index = a;
            var f = c.categoryAxis, g = c.dx, h = c.dy, k = this.x, l = this.y, m = this.width, n = this.height, p = this.data[a];
            if (p) {
                var q = p.x[f.id], u = c.rotate, r = f.inside, s = this.stepWidth, w = this.categoryBalloon, v = this.firstTime, t = this.lastTime, A = this.cursorPosition, E = f.position, x = this.zooming, z = this.panning, H = c.graphs, I = f.axisThickness;
                if (c.mouseIsOver || x || z || this.forceShow)if (this.forceShow = !1, z) {
                    var g = this.panClickPos, c = this.panClickEndTime, x = this.panClickStartTime, B = this.panClickEnd, k = this.panClickStart,
                        d = (u ? g - e : g - d) / s;
                    if (!f.parseDates || f.equalSpacing)d = Math.round(d);
                    0 !== d && (g = {type: "zoomed", target: this}, g.chart = this.chart, f.parseDates && !f.equalSpacing ? (c + d > t && (d = t - c), x + d < v && (d = v - x), g.start = x + d, g.end = c + d, this.fire(g.type, g)) : B + d >= this.data.length || 0 > k + d || (g.start = k + d, g.end = B + d, this.fire(g.type, g)))
                } else {
                    "start" == A && (q -= f.cellWidth / 2);
                    "mouse" == A && c.mouseIsOver && (q = u ? e - 2 : d - 2);
                    if (u) {
                        if (0 > q)if (x)q = 0; else {
                            this.hideCursor();
                            return
                        }
                        if (q > n + 1)if (x)q = n + 1; else {
                            this.hideCursor();
                            return
                        }
                    } else {
                        ...
                        if (q > m)if (x)q = m; else {
                            this.hideCursor();
                            return
                        }
                    }
                    0 < this.cursorAlpha && (v = this.line, u ? (t = 0, s = q + h) : (t = q, s = 0), A = this.animationDuration, 0 < A && !this.zooming ? isNaN(this.previousX) ? v.translate(t, s) : (v.translate(this.previousX, this.previousY), v.animate({translate: t + "," + s}, A, "easeOutSine")) : v.translate(t, s), this.previousX = t, this.previousY = s, v.show());
                    this.linePos = u ? q + h : q;
                    x && (u ? this.updateSelectionSize(NaN, q) : this.updateSelectionSize(q, NaN));
                    s = !0;
                    x && (s = !1);
                    this.categoryBalloonEnabled &&
                        ...
                        p.category)), w.showBalloon(f)) : w.showBalloon(p.category)) : w.hide();
                    ...
                    if (a != this.previousIndex || B != this.previousMostCloseGraph)if (this.normalizeBulletSize(), this.destroyValueBalloons(),
                        this.resizedBullets = [], H && this.valueBalloonsEnabled && s && c.balloon.enabled) {
                        ...
                        for (t = 0; t < H.length; t++)if (f = H[t], (!this.oneBalloonOnly || f == B) && f.showBalloon && !f.hidden && f.balloonText && (w = p.axes[f.valueAxis.id].graphs[f.id], v = w.y, !isNaN(v))) {
                            ...
                            s && (1 != this.graphBulletSize && AmCharts.isModern && (s = w.bulletGraphics) && (s.getBBox(), s.translate(w.bx, w.by, this.graphBulletSize), this.resizedBullets.push(w)), s = f.valueBalloon,
                    ...
                    b ? (g = {type: "changed"}, g.index = a, g.target = this, g.chart = this.chart, g.zooming = x, g.mostCloseGraph =
                        B, g.position = u ? e : d, g.target = this, c.fire("changed", g), this.fire("changed", g), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({construct: function () {
    ...
    c = h.x + e;
    d = h.y + f;
    var k = h.width, h = h.height, l = this.rotate, m = this.chart, n = this.width, p = this.height, q = m.mouseX, u = m.mouseY;
    a = this.initialMouse;
    m.mouseIsOver && (this.dragging && (m = this.initialCoord, l ? (a = m + (u - a), 0 > a && (a = 0), m = p - h, a > m && (a = m), g.setAttr("y", a)) : (a = m + (q - a), 0 > a && (a = 0), m = n - k, a > m && (a = m), g.setAttr("x", a))), this.resizingRight &&
...
AmCharts.ChartScrollbar = AmCharts.Class({inherits: AmCharts.SimpleChartScrollbar, construct: function () {
    ...
    if (a = this.graph) {
        ...
        c || (this.valueAxis = c = new AmCharts.ValueAxis,
            c.visible = !1, c.scrollbar = !0, c.axisItemRenderer = AmCharts.RecItem, c.axisRenderer = AmCharts.RecAxis, c.guideFillRenderer = AmCharts.RecFill, c.labelsEnabled = !1, c.chart = b);
    ...
    if (l = a.graph) {
        ...
        for (q = 0; q < c.length; q++) {
            var u = c[q].axes[p.id].graphs[l.id].values, r;
        ...
        -Infinity != g && (n.maximum = g + 0.1 * (g - f));
    ...
    if (this.skipEvent)this.skipEvent = !1; else {
        ...
        } else if (f.startOnAxis || (b += g / 2), c -= this.stepWidth / 2, d = f.xToIndex(b), b = f.xToIndex(b + c), d != this.start || this.end !=
    ...
    d.parseDates && !d.equalSpacing ? (c = d.stepWidth, d = a.firstTime, a = c * (this.startTime - d),
        b = c * (this.endTime - d)) : (a = c[this.start].x[d.id], b = c[this.end].x[d.id], c = d.stepWidth, d.startOnAxis || (d = c / 2, a -= d, b += d));
    this.stepWidth = c;
...
AmCharts.AmBalloon = AmCharts.Class({construct: function () {
    ...
    if (!isNaN(a)) {
        ...
        if (this.show) {
            var g = this.l, h = this.t, k = this.r, l = this.b, m = this.balloonColor,
                n = this.fillColor, p = this.borderColor, q = n;
            void 0 != m && (this.adjustBorderColor ? q = p = m : n = m);
            var u = this.horizontalPadding, r = this.verticalPadding, s = this.pointerWidth, w = this.pointerOrientation, v = this.cornerRadius, t = c.fontFamily, A = this.fontSize;
            ...
            A < g && (A = g);
            A + x > k && (A = k - x);
            var h = z + r, l = A + u, r = this.shadowAlpha, I = this.shadowColor,
                u = this.borderThickness, B = this.bulletSize, ba;
            0 < v || 0 === s ? (0 < r && (a = AmCharts.rect(e, x, t, n, 0, u + 1, I, r, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), n = AmCharts.rect(e, x, t, n, this.fillAlpha, u, p, this.borderAlpha, this.cornerRadius), this.showBullet && (ba = AmCharts.circle(e, B, q, this.fillAlpha), f.push(ba))) : (q = [], v = [], "H" != w ? (g = a - A, g > x - s && (g = x - s), g < s && (g = s), q = [0, g - s, a - A, g + s, x, x, 0, 0], v = H ? [0, 0, b - z, 0, 0, t, t, 0] : [t, t, b - z, t, t, 0, 0, t]) : (q = b - z, q > t - s && (q = t - s), q < s && (q = s), v = [0, q - s, b - z, q + s,
                t, t, 0, 0], q = a < g + (k - g) / 2 ? [0, 0, A < a ? 0 : a - A, 0, 0, x, x, 0] : [x, x, A + x > a ? x : a - A, x, x, 0, 0, x]), 0 < r && (a = AmCharts.polygon(e, q, v, n, 0, u, I, r), a.translate(1, 1), f.push(a)), n = AmCharts.polygon(e, q, v, n, this.fillAlpha, u, p, this.borderAlpha));
            this.bg = n;
            f.push(n);
            n.toFront();
            e = 1 * this.deltaSignX;
            ...
            0 < this.animationDuration && !d && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY),
                f.animate({translate: A - e + "," + z}, b, "easeOutSine"), m && (E.left = this.prevTX + "px", E.top = this.prevTY + "px", this.xAnim = c.animate({node: m}, "left", this.prevTX, l, b, "easeOutSine", "px"), this.yAnim = c.animate({node: m}, "top", this.prevTY, h, b, "easeOutSine", "px")));
            this.prevX = A - e;
            this.prevY = z;
            this.prevTX = l;
            this.prevTY = h
    ...
    if (this.follow && this.show) {
        ...
        this.pointToX = a;
        this.pointToY = b;
        if (a != this.previousX || b != this.previousY)if (this.previousX =
            a, this.previousY = b, 0 === this.cornerRadius)this.draw(); else {
            var c = this.set;
            if (c) {
...
AmCharts.AmCoordinateChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function () {
    ...
    d.duration && b.values.value && (d = AmCharts.formatDuration(b.values.value, d.duration, "", d.durationUnits, d.maxInterval, d.numberFormatter),
        a = a.split("[[value]]").join(d));
    a = AmCharts.massReplace(a, {"[[title]]": c.title, "[[description]]": b.description});
...
AmCharts.AmSlicedChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function () {
    ...
    a = AmCharts.formatValue(a, b, ["value"],
    ...
    var a;
    for (a = 0; a < this.chartData.length; a++)0 < this.startDuration && this.sequencedAnimation ? this.setStartTO(a) :
        this.startSlice(this.chartData[a])
    ...
    b && 0 < c && (0 < a.alpha && b.show(), b.translate(a.startX, a.startY), b.animate({opacity: a.alpha, translate: "0,0"}, c, this.startEffect))
}, showLabels: function () {
    var a = this.chartData, b;
    for (b = 0; b < a.length; b++) {
        var c = a[b];
    ...
    var f = this.formatString(this.balloonText, a), g = AmCharts.adjustLuminosity(a.color, -0.15);
    ...
    a = this.chartData;
    var b;
    for (b = 0; b < a.length; b++)a[b].pulled || this.pullSlice(a[b],
        1)
}, parseData: function () {
    var a = [];
    this.chartData = a;
    ...
    if (void 0 !== b) {
        ...
        for (e = 0; e < c; e++) {
            ...
            f.visibleInLegend =
                AmCharts.toBoolean(h[this.visibleInLegendField], !0);
            g = h[this.alphaField];
        ...
        1 < b && (this.groupValue = 0, this.removeSmallSlices(), a.push({title: this.groupedTitle, value: this.groupValue, percents: 100 * (this.groupValue / d), pulled: this.groupedPulled,
            color: this.groupedColor, url: this.groupedUrl, description: this.groupedDescription, alpha: this.groupedAlpha, pattern: this.groupedPattern}));
        c = this.baseColor;
    ...
    for (c = 0; c < a.length; c++)d =
        a[c], !d.hidden && 0 < d.value && (b += d.value);
    ...
    for (c = 0; c < a.length; c++) {
        var d =
            this.formatString(this.labelText, a[c]), d = AmCharts.text(this.container, d, this.color, this.fontFamily, this.fontSize), e = d.getBBox().width;
        e > b && (b = e);
        d.remove()
    }
    return b
...
AmCharts.AmRectangularChart = AmCharts.Class({inherits: AmCharts.AmCoordinateChart, construct: function () {
    ...
    this.zoomOutButton = {backgroundColor: "#e5e5e5", backgroundAlpha: 1};
    this.trendLines = [];
    this.autoMargins = !0;
    this.marginsUpdated = !1;
    ...
    b = f - c;
    var l;
    for (l = 0; l < a.length; l++)b =
        this.getAxisBounds(a[l], g, k, h, b), g = b.l, k = b.r, h = b.t, b = b.b;
    ...
    c.translate(26,
        6 + d.height / 2);
    var f = e.backgroundColor, e = e.backgroundAlpha, e = AmCharts.rect(a.container, d.width + 35, d.height + 15, f, e, 1, f, e);
    b.push(e);
    a.zbBG = e;
    ...
    for (c = 0; c < b.length; c++)b[c].attr({cursor: "pointer"});
    a.zbSet = b
}, rollOverZB: function () {
    this.zbBG.show()
}, rollOutZB: function () {
...
AmCharts.TrendLine = AmCharts.Class({construct: function () {
    ...
    var a = this;
    a.destroy();
    var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, n = a.finalCategory, p = a.valueAxis, q = a.valueAxisX, u = a.initialXValue, r = a.finalXValue, s = a.initialValue, w = a.finalValue, v = p.recalculateToPercents, t = b.dataDateFormat;
    h && (k && (k instanceof
    ...
    isNaN(d) || isNaN(e) || isNaN(f) || isNaN(f) || (b.rotate ? (h = [f, g], e = [d, e]) : (h = [d, e], e = [f, g]),
        f = a.lineColor, d = AmCharts.line(c, h, e, f, a.lineAlpha, a.lineThickness, a.dashLength), e = AmCharts.line(c, h, e, f, 0.005, 5), c = c.set([d, e]), c.translate(b.marginLeftReal, b.marginTopReal), b.trendLinesSet.push(c), a.line = d, a.set = c, e.mouseup(function () {
        a.handleLineClick()
    }).mouseover(function () {
        a.handleLineOver()
    }).mouseout(function () {
...
AmCharts.bullet = function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    switch (b) {
        ...
        case "triangleDown":
            ...
            break;
        case "triangleLeft":
            n = AmCharts.triangle(a, c, 270, d, e,
                f, g, h);
            break;
        case "triangleRight":
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    g = p(g);
    h = p(h);
    var q = p(g / f * h), u = AmCharts.VML, r = 359.5 + f / 100;
    359.94 < r && (r = 359.94);
    e >= r && (e = r);
    var s = 1 / 180 * Math.PI, r = b + Math.sin(d * s) * h, w = c - Math.cos(d * s) * q, v = b + Math.sin(d * s) * f, t = c - Math.cos(d * s) * g, A = b + Math.sin((d + e) * s) * f, E = c - Math.cos((d + e) * s) * g, x = b + Math.sin((d + e) * s) * h, s = c - Math.cos((d + e) * s) * q, z = {fill: AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity": 0}, H = 0;
    180 < Math.abs(e) && (H = 1);
    d = a.set();
    var I;
    u && (r = p(10 * r), v = p(10 * v), A = p(10 *
        A), x = p(10 * x), w = p(10 * w), t = p(10 * t), E = p(10 * E), s = p(10 * s), b = p(10 * b), k = p(10 * k), c = p(10 * c), f *= 10, g *= 10, h *= 10, q *= 10, 1 > Math.abs(e) && 1 >= Math.abs(A - v) && 1 >= Math.abs(E - t) && (I = !0));
    e = "";
    var B;
    0 < k && (u ? (B = " M" + r + "," + (w + k) + " L" + v + "," + (t + k), I || (B += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + v + "," + (t + k) + "," + A + "," + (E + k)), B += " L" + x + "," + (s + k), 0 < h && (I || (B += " B" + (b - h) + "," + (k + c - q) + "," + (b + h) + "," + (k + c + q) + "," + x + "," + (k + s) + "," + r + "," + (k + w)))) : (B = " M" + r + "," + (w + k) + " L" + v + "," + (t + k) + (" A" + f + "," + g + ",0," + H + ",1," + A + "," + (E + k) + " L" +
        x + "," + (s + k)), 0 < h && (B += " A" + h + "," + q + ",0," + H + ",0," + r + "," + (w + k))), B += " Z", B = a.path(B, void 0, void 0, "1000,1000").attr(z), d.push(B), B = a.path(" M" + r + "," + w + " L" + r + "," + (w + k) + " L" + v + "," + (t + k) + " L" + v + "," + t + " L" + r + "," + w + " Z", void 0, void 0, "1000,1000").attr(z), k = a.path(" M" + A + "," + E + " L" + A + "," + (E + k) + " L" + x + "," + (s + k) + " L" + x + "," + s + " L" + A + "," + E + " Z", void 0, void 0, "1000,1000").attr(z), d.push(B), d.push(k));
    u ? (I || (e = " A" + p(b - f) + "," + p(c - g) + "," + p(b + f) + "," + p(c + g) + "," + p(v) + "," + p(t) + "," + p(A) + "," + p(E)), f = " M" + p(r) + "," + p(w) +
        " L" + p(v) + "," + p(t) + e + " L" + p(x) + "," + p(s)) : f = " M" + r + "," + w + " L" + v + "," + t + (" A" + f + "," + g + ",0," + H + ",1," + A + "," + E) + " L" + x + "," + s;
...
AmCharts.AmLegend = AmCharts.Class({construct: function () {
    ...
    var a = this.position, b = this.marginLeft +
        this.titleWidth, c = this.marginRight, d = this.marginTop, e = this.marginBottom, f = this.horizontalGap, g = this.div, h = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing, n = h - c - b, p = 0, q = 0, u = this.container, r = u.set();
    this.set = r;
    u = u.set();
    r.push(u);
    var s = this.entries, w, v;
    ...
    for (v = 0; v < s.length; v++) {
        ...
        w = x.getBBox();
        var z;
        this.equalWidths ? z = f + A * (p + m + this.markerLabelGap) :
            (z = E, E = E + w.width + f + m);
    ...
    c.toBack();
    b = f;
    if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)"center" == this.align ? b = f + (h -
        w.width) / 2 : "right" == this.align && (b = f + h - w.width);
    u.translate(b, l + 1);
    ...
    if (!1 !== a.visibleInLegend) {
        ...
        if (f = this.switchType)n = "x" == f ? this.createX() : this.createV(), n.dItem = a, !0 !== a.hidden ? "x" == f ? n.hide() : n.show() : "x" != f && n.hide(), this.switchable || n.hide(), this.addListeners(n,
        ...
        var p;
        d && (d = AmCharts.fixNewLines(d), a.legendTextReal = d, p = AmCharts.text(this.container, d, f, b.fontFamily, n, "start"), p.translate(this.lx + m, this.ly), k.push(p), b = p.getBBox().width,
    ...
    var a = this.markerSize - 3, b = {stroke: this.switchColor,
        "stroke-width": 3}, c = this.container, d = AmCharts.line(c, [3, a], [3, a]).attr(b), a = AmCharts.line(c, [3, a], [a, 3]).attr(b);
    ...
    for (c =
             0; c < a.length; c++) {
        var d = a[c], e = d.dItem, f = " ";
        if (void 0 !== e.type) {
            var g = e.currentDataItem, h = this.periodValueText;
...
// Hechzh 2014.3.31 Modified.  Show Chinese Month Description.
...
AmCharts.formatDate = function (a, b) {
    ...
    var n = String(c).substr(2, 2), p = d + 1;
    9 > d && (p = "0" + p);
    var q = e;
    10 > e && (q = "0" + e);
    var u = "0" + f;
